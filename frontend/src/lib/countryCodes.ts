...
// All country/territory calling codes (ITU/libphonenumber data), sorted numerically
// by dial code ascending (ties broken alphabetically by country name).
export const COUNTRY_CODES: CountryCode[] = [
  ...
  { code: '+599', label: 'Caribbean Netherlands' },
  { code: '+599', label: 'Curaçao' },
  { code: '+670', label: 'Timor-Leste' },
  { code: '+672', label: 'Antarctica' },
  { code: '+672', label: 'Heard Island and McDonald Islands' },
